...
Optional LLM-local reorder: `helpers/rank_pack.py` after pack ([`helpers/registry.json`](../../../helpers/registry.json)). Example: `/pack design_a_form`. No file. Host does not pass or fail.
