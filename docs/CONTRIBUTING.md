...
**Docs:** human centered, plain language, task first. See the note at the top of [Documentation map](README.md). Do not edit `catalog/MANIFEST.md` by hand; it is generated.
