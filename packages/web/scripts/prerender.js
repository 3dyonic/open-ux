...
import { telemetryPage } from "../src/telemetry.js";
import { callerPage } from "../src/caller.js";
...
await writePage("admin/telemetry/index.html", template, telemetryPage());
await writePage("admin/telemetry/callers/index.html", template, callerPage());
