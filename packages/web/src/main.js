...
import { renderCaller } from "./caller.js";
...
function route() {
  ...
  if (path === "/admin/telemetry") return renderTelemetry(root);
  if (path.startsWith("/admin/telemetry/callers/")) return renderCaller(root);
