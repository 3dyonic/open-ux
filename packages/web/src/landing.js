  ...
  <section class="flex w-full flex-col items-start gap-4 px-5 py-4 pb-8 md:px-12">
    ...
    <div class="flex w-full flex-col items-stretch gap-4 md:flex-row">
      <article class="flex h-auto flex-1 flex-col gap-2.5 overflow-hidden rounded-sm border border-line bg-card p-4 md:h-[143px]">
        ...
        <p class="m-0 text-[14px] leading-[18px] text-muted">Install the plugin and configure your key.</p>
      </article>
      <article class="flex h-auto flex-1 flex-col gap-2.5 overflow-hidden rounded-sm border border-line bg-card p-4 md:h-[143px]">
        ...
        <p class="m-0 text-[14px] leading-[18px] text-muted">Pick a situation, from the whole surface down to a small piece.</p>
      </article>
      <article class="flex h-auto flex-1 flex-col gap-2.5 overflow-hidden rounded-sm border border-line bg-card p-4 md:h-[143px]">
        ...
        <p class="m-0 text-[14px] leading-[18px] text-muted">Open UX gives cited rules with examples. The LLM judges the UI.</p>
      </article>
    </div>
  </section>
  </main>
