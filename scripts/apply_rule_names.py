...
OVERRIDES = {
    ...
    "govuk.hide-password-by-default-show-toggle": "Hide password by default; show toggle",
    "govuk.avoid-confirm-password-field": "Avoid a confirm-password field",
    "govuk.allow-copy-paste-in-password-fields": "Allow copy and paste in password fields",
