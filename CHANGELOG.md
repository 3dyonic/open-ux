...
- **Plugin 1.2.1:** bare `/open-ux:open-ux` — map call, then fixed verbatim modal in [`bare-invoke.md`](clients/plugin/skills/open-ux/bare-invoke.md) (container → Cards table, one question).
