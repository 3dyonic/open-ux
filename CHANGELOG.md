...
- **Plugin 1.2.1:** bare `/open-ux:open-ux` — map call first, then container-grouped summary (areas → Cards, `cards.md` shape), then one interview question; not a flat example list without the drill-down.
