...
- **Plugin 1.2.1:** bare `/open-ux:open-ux` — verbatim onboarding in [`bare-invoke.md`](clients/plugin/skills/open-ux/bare-invoke.md) (what Open UX is, invoke with task, agent uses it for review and guidelines); map tools wait for a task.
