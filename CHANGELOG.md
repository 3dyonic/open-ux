...
- **Plugin 1.2.1:** bare `/open-ux:open-ux` — verbatim onboarding in [`bare-invoke.md`](clients/plugin/skills/open-ux/bare-invoke.md): what it is, how it guides the LLM (map → pull → cite), your turn; map tools wait for a task.
